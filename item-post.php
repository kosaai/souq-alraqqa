...
<body id="body-item-post">
    ...
    <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data">
        ...
        <fieldset class="general i-shadow round3" data-step-id="1">
          ...
          <?php if($category_type == 1 || $category_type == '') { ?>
            ...
            <div class="row category flat">
              ...
              <input id="catId" type="hidden" name="catId" value="<?php echo (starter_get_session('sCategory') <> '' ? starter_get_session('sCategory') : Params::getParam('sCategory')); ?>">
      ...
      <div class="right-col">
        ...
        <?php 
          ...
          $prepare['i_country'] = starter_get_session('sCountry') <> '' ? starter_get_session('sCountry') : osc_user_field('fk_c_country_code');
          $prepare['i_region'] = starter_get_session('sRegion') <> '' ? starter_get_session('sRegion') : osc_user_region_id();
          $prepare['i_city'] = starter_get_session('sCity') <> '' ? starter_get_session('sCity') : osc_user_city_id();
          $prepare['s_phone'] = starter_get_session('sPhone') <> '' ? starter_get_session('sPhone') : osc_user_phone();
        ?>
          ...
          <div class="location">
            <div class="row">
              ...
              <div id="location-picker">
                <input type="text" name="term" id="term" class="term" placeholder="<?php _e('البلد أو المنطقة أو المدينة', 'starter'); ?>" value="<?php echo starter_get_term(starter_get_session('term'), $prepare['i_country'], $prepare['i_region'], $prepare['i_city']); ?>" autocomplete="off"/>
      ...
      <div class="buttons-block">
        <div class="inside">
          ...
          <button type="submit" class="btn btn-primary"><?php _e('نشر العنصر', 'starter'); ?></button>
  ...
  <script type="text/javascript">
    ...
    <?php 
      $e_array = starter_extra_fields_hide();
