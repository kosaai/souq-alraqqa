...
<body id="body-user-public-profile">
  ...
  <div class="content user_public_profile">
    ...
    <h1><?php echo sprintf(__('أحدث القوائم %s', 'starter'), osc_user_name()); ?></h1>
    ...
    <div id="public-items" class="white">
      ...
      <?php } else { ?>
        <div class="empty"><?php _e('لا توجد قوائم نشرها هذا البائع', 'starter'); ?></div>
      <?php } ?>
    </div>
              ...
              <div class="side-photo">
                ...
                <div class="name">
                  ...
                  <?php if(osc_user_id() <> 0 and osc_user_id() <> '') { ?>
                    <a href="<?php echo osc_user_public_profile_url(osc_user_id()); ?>" title="<?php echo osc_esc_html(__('التحقق من الملف الشخصي لهذا المستخدم', 'starter')); ?>">
                      <?php echo $c_name; ?>
                    </a>
                  <?php } else { ?>
                    <?php echo $c_name; ?>
            ...
            <div class="item-actions">
              <?php if($mobile_found) { ?>
                <div class="row phone">
                  ...
                  <a href="#" class="phone-block has-tooltip" data-item-id="<?php echo osc_item_id(); ?>" data-item-user-id="<?php echo osc_user_id(); ?>" title="<?php echo osc_esc_js(__('انقر لإظهار رقم الهاتف', 'starter')); ?>">
                    <span>
                      <?php 
              ...
              <div class="row">
                ...
                <?php } else { ?>
                  ...
                  <a class="item-contact" href="<?php echo osc_item_send_friend_url(); ?>"><?php _e('اتصل بالبائع', 'starter'); ?></a>
                <?php } ?>
              </div>
              <?php } ?>
              ...
              <?php if(osc_user_id() <> 0) { ?>
                <div class="row dash">
                  ...
                  <?php } else { ?>
                    <a href="<?php echo osc_user_public_profile_url(osc_user_id()); ?>"><?php _e('لوحة القيادة', 'starter'); ?></a>
                  <?php } ?>
                </div>
              <?php } ?>
        ...
        <div class="pub-contact-wrap">
          <div class="ins">
            <?php if(@$user_keep['pk_i_id'] == osc_logged_user_id() && osc_logged_user_id() > 0) { ?>
              <div class="empty"><?php _e('هذا هو ملفك الشخصي العام، نموذج الاتصال معطل بالنسبة لك', 'starter'); ?></div>
            <?php } else { ?>
              <?php if(osc_reg_user_can_contact() && osc_is_web_user_logged_in() || !osc_reg_user_can_contact() ) { ?>
                <a id="pub-contact" href="<?php echo osc_item_send_friend_url(); ?>" class="btn btn-primary" rel="<?php echo osc_user_id(); ?>"><?php _e('اتصل بالبائع', 'starter'); ?></a>
              <?php } ?>
            <?php } ?>
          </div>
        </div>
