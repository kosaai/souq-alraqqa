    ...
    <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data">
          ...
          <div class="location">
            <div class="row">
              ...
              <div id="location-picker">
                <input type="text" name="term" id="term" class="term" placeholder="<?php _e('Country, Region or City', 'starter'); ?>" value="<?php echo starter_get_term(starter_get_session('term'), $prepare['i_country'], $prepare['i_region'], $prepare['i_city']); ?>" autocomplete="off"/>
      ...
      <div class="buttons-block">
        <div class="inside">
          ...
          <button type="submit" class="btn btn-primary"><?php _e('Publish item', 'starter'); ?></button>
