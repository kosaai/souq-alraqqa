  ...
  <div class="simple-wrap">
    ...
    <div class="item-img-wrap">
      ...
      <div class="img-bottom">
        ...
        <?php if(osc_count_premium_resources()) { ?>
          <a class="orange-but open-image" href="<?php echo starter_item_send_friend_url(osc_premium_id()); ?>"><i class="fa fa-search"></i><span><?php _e('معاينة', 'starter'); ?></span></a>
        <?php } else { ?>
          <a class="orange-but" href="#" onclick="return false;" style="opacity:0.5;cursor:not-allowed;"><i class="fa fa-search"></i><span><?php _e('معاينة', 'starter'); ?></span></a>
        <?php } ?>
      </div>
    </div>
