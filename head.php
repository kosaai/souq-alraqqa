...
<script type="text/javascript">
  ...
  var fileDefaultText = '<?php echo osc_esc_js(__('لم يتم تحديد أي ملف', 'starter')); ?>';
  var fileBtnText     = '<?php echo osc_esc_js(__('اختر ملف', 'starter')); ?>';
  ...
  var starterClickOpen = '<?php echo osc_esc_js(__('انقر لفتح القائمة', 'starter')); ?>';
  var starterNoMatch = '<?php echo osc_esc_js(__('لا توجد قائمة مطابقة لمعاييرك', 'starter')); ?>';
